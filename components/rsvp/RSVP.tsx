...
import { MapPin, Calendar, Hotel, Users, Phone } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-[#4A121A] text-[#F5F0EB] hover:bg-[#404734] py-4 rounded-full uppercase tracking-[0.25em] text-xs font-semibold transition-colors duration-300 shadow-sm"
            >
              Submit RSVP
            </button>
          </form>
            ...
            <div className="p-6 bg-[#EFE8DF] border border-[#C2A675]/35 rounded-3xl backdrop-blur-sm space-y-4 shadow-sm">
              ...
              <div className="flex flex-col gap-3 pt-2">
                <button
                  ...
                  className="flex items-center gap-4 bg-[#F5F0EB] border border-[#C2A675]/30 hover:border-[#4A121A]/50 p-4 rounded-xl text-left w-full transition-all group shadow-sm"
                >
