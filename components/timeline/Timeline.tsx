...
const track = [
  { epoch: "Part I", name: "The Wedding Ceremony", hr: "10:00 AM", detail: "The arrival of guests followed by our exchange of vows, rings, and beautiful spiritual celebrations." },
  { epoch: "Part II", name: "The Reception Feast", hr: "01:00 PM", detail: "A premium culinary experience paired with traditional cultural honors, speeches, and the cutting of the cake." },
  { epoch: "Part III", name: "The After Party", hr: "07:00 PM", detail: "Atmospheric lighting shifts, live music arrangements, and an infinite dance sequence to crown the night." },
];

export default function Timeline() {
  return (
    <section className="py-24 bg-[#0E1719] px-6 relative overflow-hidden border-b border-[#8DD2DB]/10">
        ...
        <div className="space-y-6">
          {track.map((evt, i) => (
            <motion.div
              ...
              animate={{ 
                boxShadow: ["0px 0px 0px rgba(141,210,219,0)", "0px 4px 20px rgba(141,210,219,0.03)", "0px 0px 0px rgba(141,210,219,0)"]
              }}
              transition={{ 
                initial: { duration: 0.6, delay: i * 0.1 },
